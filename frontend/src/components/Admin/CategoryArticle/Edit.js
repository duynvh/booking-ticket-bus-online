...
class Edit extends Component {
    ...
    componentWillMount() {
        this.loadCategory(this.props.id);
    }
    ...
    handleSubmit = (event) => {
        ...
        if(name === "") {
            this.setState({
                msg: 'Please input name category article'
            });
        }
        else {
            let formProps = {
            ...
            this.props.editCategoryArticle(this.props.id,formProps, () => {
                this.context.router.history.push('/admin/category-article');
            });
        }
                        ...
                        <div className="col-12">
                            <div className="card card-primary">
                                <div className="card-header">
                                    <h3 className="card-title">Edit Category Article</h3>
                                </div>
...
function mapStateToProps(state) {
    return { 
        message: state.category_article.message,
    };
}
