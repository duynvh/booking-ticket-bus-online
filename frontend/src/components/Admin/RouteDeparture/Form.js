...
class Form extends Component {
    ...
    handleSubmit = (event) => {
        this.props.clearMsg();
        let {name, address,hotline, status, ordering, category_schedule_id} = this.state;
        if(name === "") {
            this.setState({
            ...
            this.props.createRouteDeparture(formProps, () => {
                        ...
                        <div className="col-12">
                            <div className="card card-primary">
                                <div className="card-header">
                                    <h3 className="card-title">Add Route Departure</h3>
                                </div>
